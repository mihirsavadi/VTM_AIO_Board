/* MPU9250 Basic Example Code
 ...
 Note: The MPU9250 is an I2C sensor and uses the Arduino Wire1 library.
 Because the sensor is not 5V tolerant, we are using a 3.3 V 8 MHz Pro Mini or a 3.3 V Teensy 3.1.
 We have disabled the internal pull-ups used by the Wire1 library in the Wire1.h/twi.c utility file.
